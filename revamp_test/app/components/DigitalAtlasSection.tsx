          ...
          <div className="sticky top-0 h-screen flex items-center justify-center">
              ...
              <div className="rounded-2xl overflow-hidden bg-black shadow-lg">
                <div className="w-full h-[48vh] sm:h-[40vh] relative">
                  <video className="w-full h-full object-cover" autoPlay muted loop playsInline>
                    <source src="https://res.cloudinary.com/dtmcz8fs8/video/upload/v1766573875/scan_ahetcz.webm" type="video/webm" />
                  </video>
                </div>
            ...
            >
              <div className="rounded-2xl overflow-hidden bg-black shadow-lg">
                <div className="w-full h-[48vh] sm:h-[40vh] relative">
                  <video className="w-full h-full object-cover" autoPlay muted loop playsInline>
                    <source src="https://res.cloudinary.com/dtmcz8fs8/video/upload/v1766573133/digi2_hw2c4b.webm" type="video/webm" />
                  </video>
                </div>
                <div className="py-6 px-4 text-center">
